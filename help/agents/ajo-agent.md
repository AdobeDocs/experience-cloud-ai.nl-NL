---
title: Overzicht en gebruikershandleiding van Journey Agent
description: Uitgebreide gids voor Journey Agent, waarmee gebruikers marketingreizen kunnen maken, analyseren en optimaliseren met behulp van een natuurlijke taalinterface in Journey Optimizer.
...
# Journey Agent: Overzicht en gebruikershandleiding

## Inleiding tot Journey Agent in Adobe Journey Optimizer
...
1. **Analyse van de Fallout van de Reis**
   ...
   - Identificeer waar en waarom klanten tijdens een reis weggaan.
...
Hier zijn voorbeelden van waardevolle herinneringen gebruikers kunnen hefboomwerking gebruiken om, hun reizen te onderzoeken te controleren en problemen op te lossen.
...
>[!NOTE]
>
>Hier vindt u dia&#39;s en presentatiemateriaal voor Journey Agent. Kom binnenkort terug voor updates.
