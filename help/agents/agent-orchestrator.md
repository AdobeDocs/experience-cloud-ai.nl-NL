...
| --- | --- | --- |
| [&#x200B; Adobe Marketing Agent voor  [!DNL Microsoft 365 Copilot]](ama-ms.md) | Haal direct marketinginzichten van Adobe Experience Platform op in [!DNL Microsoft 365] -toepassingen zoals [!DNL Teams] , [!DNL Word] , [!DNL Powerpoint] en [!DNL Excel] . Met deze agent kunt u chatgeschiedenis bijhouden voor verschillende apps en uw gesprek probleemloos voortzetten terwijl u werkt. |
...
Alle gebruikers krijgen toegang tot AI Assistant en de bijbehorende Experience Platform-agents.
